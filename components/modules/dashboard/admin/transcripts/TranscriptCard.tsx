...
import { User, GraduationCap, Calendar, Award, FileText, Download, Eye } from "lucide-react"
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              <p className="text-sm font-medium text-muted-foreground">Credits Registered</p>
              <p className="text-lg font-bold text-blue-600">{transcript.creditsRegistered}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm font-medium text-muted-foreground">Credits Valid</p>
              <p className="text-lg font-bold text-green-600">{transcript.creditsValid}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm font-medium text-muted-foreground">Total Credits Valid</p>
              <p className="text-lg font-bold text-green-600">{transcript.totalCreditsValid}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm font-medium text-muted-foreground">General Average</p>
              <p className="text-lg font-bold text-purple-600">{transcript.averageGenerale.toFixed(2)}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm font-medium text-muted-foreground">Cumulative Average</p>
              <p className="text-lg font-bold text-purple-600">{transcript.cumulativeAverage.toFixed(2)}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm font-medium text-muted-foreground">Signature Date</p>
          ...
          <>
            ...
            <div className="space-y-4">
              <h4 className="font-semibold flex items-center gap-2">
                ...
                Course Grades ({transcript.grades.length} courses)
              </h4>
